label demo_forest:
    ...
    show sprite_medusa_pond_neutral at Position(xalign=0.7) with dissolve
    ...
    pause 1.0
    show sprite_medusa_pond_sigh at Position(xalign=0.7)
    ...
    show sprite_medusa_pond_surprised at Position(xalign=0.7)
    ...
    medusa "Pan is such an uncivilized brute!" # VA: Snapping, much unlike the gentle Athena we've seen so far. 
    ...
    pause 1.0
    show sprite_athena_robes_neutral at Position(xalign=0.3)
    ...
    show sprite_medusa_pond_dismissive at Position(xalign=0.7)
    ...
    show sprite_athena_robes_annoyed at Position(xalign=0.3)
    ...
    menu m_priestess:
        ...
        "Piss Athena off by being sarcastic":
            ...
            show sprite_athena_robes_angry at Position(xalign=0.3)
            play sound audio.athena_angry
            show sprite_medusa_pond_scared at Position(xalign=0.7)
            ...
            show sprite_athena_robes_tired at Position(xalign=0.3)
            ...
            pause 2.0
            show sprite_medusa_pond_happy at Position(xalign=0.7)
    ...
    pause 2.0
    show sprite_athena_robes_determined at Position(xalign=0.3)
    ...
    show sprite_medusa_pond_sad at Position(xalign=0.7)
    ...
    show sprite_athena_robes_happy at Position(xalign=0.3)
    ...
    show sprite_medusa_pond_eyebrow at Position(xalign=0.7)
    ...
    menu m_athena_activity:
        ...
        "The Owl House":
            ...
            show sprite_athena_robes_thinking at Position(xalign=0.3)
            ...
            show sprite_athena_robes_lightbulb at Position(xalign=0.3)
            pause 2.0
            show sprite_athena_robes_happy at Position(xalign=0.3)
        ...
        "Get into the pond with me":
            ...
            show sprite_athena_robes_red at Position(xalign=0.3)
            ...
            show sprite_athena_bra_neutral at Position(xalign=0.3)
            show sprite_medusa_pond_blush at Position(xalign=0.7)
            medusa "Oh my." # VA: Flustered admiration.
            show sprite_athena_bra_happy at Position(xalign=0.3)
            ...
            show sprite_athena_bra_annoyed at Position(xalign=0.3)
            ...
            scene cg_athena_medusa_pond with Dissolve(2.0)
